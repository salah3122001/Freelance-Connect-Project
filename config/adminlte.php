    ...
    */
    ...
    'menu' => [
        ...
        [
            'search' => true,
            'text' => 'Search...',
            'topnav' => true, // يظهر فوق في navbar
            'method' => 'GET',
        ...
        [
            'search' => true,
            'text' => 'Search...',
            'topnav' => false, // يظهر في الـ sidebar
            'method' => 'GET',
            'url' => 'admin/adminsearch',
        ],
        ...
        [
            ...
            'url'  => '/',
            'icon' => 'fas fa-globe',
            'target' => '_blank', // يفتح الموقع في تبويب جديد
            'topnav' => true, // يظهر في الشريط العلوي (navbar)
        ],
        ...
        [
            ...
            'url'  => 'admin/approvedservices',
            'icon' => 'fas fa-check-circle text-success',
        ],
        [
            'text' => 'Pending Services',
            'url'  => '/admin/services/lastservices',
            'icon' => 'fas fa-clock text-warning',
        ],
        [
            'text' => 'Rejected Services',
            'url'  => 'admin/rejectedservices',
